...
FRONTIER_EVENT_MOVES_JSON := $(DATA_SRC_SUBDIR)/pokemon/frontier_event_moves.json
FRONTIER_EVENT_LEARNSETS := $(DATA_SRC_SUBDIR)/pokemon/frontier_event_learnsets.h
FRONTIER_EVENT_LEARNSETS_TOOL := $(TOOLS_DIR)/frontier_move/generate_event_learnsets.py
...
$(FRONTIER_EVENT_LEARNSETS): $(FRONTIER_EVENT_MOVES_JSON) $(FRONTIER_EVENT_LEARNSETS_TOOL) $(INCLUDE_DIRS)/constants/species.h $(INCLUDE_DIRS)/constants/moves.h
	python3 $(FRONTIER_EVENT_LEARNSETS_TOOL)

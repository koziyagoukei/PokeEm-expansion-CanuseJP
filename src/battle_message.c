...
const u8 gText_PkmnStoppedEvolving[] = _("{JPN}おや？ {STR_VAR_1}の\nしんかが とまった！\p");
...
const u8 gText_TheGreatNewHope[] = _("{JPN}あらたな きぼう！\p");
...
static const u8 sText_PlayerLostAgainstTrainer1[] = _("{JPN}{B_TRAINER1_NAME_WITH_CLASS}に まけた！");
static const u8 sText_PlayerBattledToDrawTrainer1[] = _("{JPN}{B_TRAINER1_NAME_WITH_CLASS}と ひきわけた！");
const u8 gText_RecordBattleToPass[] = _("{JPN}このバトルを\nフロンティアパスに きろくしますか？");
const u8 gText_BattleRecordedOnPass[] = _("{JPN}{B_PLAYER_NAME}の バトルけっかを\nフロンティアパスに きろくした。");
static const u8 sText_LinkTrainerWantsToBattlePause[] = _("{JPN}{B_LINK_OPPONENT1_NAME}が しょうぶを しかけてきた！\p");

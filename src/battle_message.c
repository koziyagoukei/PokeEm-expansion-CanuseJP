...
const u8 *const gBattleStringsTable[STRINGID_COUNT] =
{
    ...
    [STRINGID_PKMNRAISEDSPDEF]                      = COMPOUND_STRING("ひかりのかべで {B_ATK_TEAM2} ポケモンは とくしゅに つよくなった！"),
    [STRINGID_PKMNRAISEDDEF]                        = COMPOUND_STRING("リフレクターで {B_ATK_TEAM2} ポケモンは ぶつりに つよくなった！"),
    ...
    [STRINGID_SHIELDEDFROMCRITICALHITS]             = COMPOUND_STRING("おまじないにより　 {B_ATK_TEAM2} ポケモン　は　きゅうしょに　あたらない！"),
    ...
    [STRINGID_PKMNSWITCHEDSTATCHANGES]              = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} はあいてと　のうりょくへんかを　いれかえた！"),
    ...
    [STRINGID_PROTECTEDTEAM]                        = COMPOUND_STRING("{B_CURRENT_MOVE} で {B_ATK_TEAM2} ポケモンは　まもられた！"),
    ...
    [STRINGID_REFLECTTARGETSTYPE]                   = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} は　{B_DEF_NAME_WITH_PREFIX2}　とおなじタイプに　なった！"),

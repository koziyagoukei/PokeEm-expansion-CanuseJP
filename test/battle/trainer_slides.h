[DIFFICULTY_NORMAL] =
{
    [TRAINER_LEAF_TEST] =
    {
        ...
        [TRAINER_SLIDE_LAST_HALF_HP] = COMPOUND_STRING("Trainer A: Enemy last Mon has below 51% HP.{PAUSE_UNTIL_PRESS}"),
        [TRAINER_SLIDE_LAST_LOW_HP] = COMPOUND_STRING("Trainer A: Enemy last Mon has below 26% HP.{PAUSE_UNTIL_PRESS}"),
    ...
    [TRAINER_RED_TEST] =
    {
        ...
        [TRAINER_SLIDE_LAST_HALF_HP] = COMPOUND_STRING("Trainer B: Enemy last Mon has below 51% HP.{PAUSE_UNTIL_PRESS}"),
        [TRAINER_SLIDE_LAST_LOW_HP] = COMPOUND_STRING("Trainer B: Enemy last Mon has below 26% HP.{PAUSE_UNTIL_PRESS}"),
    ...
    [TRAINER_PARTNER(PARTNER_STEVEN_TEST)] =
    {
        ...
        [TRAINER_SLIDE_LAST_HALF_HP] = COMPOUND_STRING("Trainer Partner: Enemy last Mon has below 51% HP.{PAUSE_UNTIL_PRESS}"),
        [TRAINER_SLIDE_LAST_LOW_HP] = COMPOUND_STRING("Trainer Partner: Enemy last Mon has below 26% HP.{PAUSE_UNTIL_PRESS}"),
